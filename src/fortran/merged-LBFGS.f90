...
real, allocatable, dimension(:), public :: xk
real, allocatable, dimension(:), public :: descent
real, allocatable, dimension(:,:), public :: sk,yk

public init_LBFGS, descent_LBFGS, LBFGS, finalize_LBFGS, save_LBFGS, update_LBFGS
